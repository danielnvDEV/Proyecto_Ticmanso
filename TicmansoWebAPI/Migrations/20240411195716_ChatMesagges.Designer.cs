...
namespace TicmansoWebAPI.Migrations
{
    ...
    [Migration("20240411195716_ChatMesagges")]
    partial class ChatMesagges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicmansoWebAPI.Models.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TicmansoWebAPI.Models.ChatMessage", b =>
                {
                    b.HasOne("TicmansoWebAPI.Models.User", "FromUser")
                        .WithMany("ChatMessagesFromUsers")
                        .HasForeignKey("FromUserId")
                        .IsRequired();

                    b.HasOne("TicmansoWebAPI.Models.User", "ToUser")
