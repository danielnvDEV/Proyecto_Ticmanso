...
namespace TicmansoV2.Shared.GenericModels
{
    public static class Generics
    {
        public static ClaimsPrincipal SetClaimPrincipal(UserSession model)
        {
            return new ClaimsPrincipal(new ClaimsIdentity(
                new List<Claim>
                {
                    ...
                    new(ClaimTypes.UserData, model.Company),
                }, "JwtAuth"));
        }
        ...
        public static UserSession GetClaimsFromToken(string jwtToken)
        {
            ...
            string Company = claims.First(c => c.Type == ClaimTypes.UserData).Value!;

            return new UserSession(Id, Name, Email, Role, Company);
        }
