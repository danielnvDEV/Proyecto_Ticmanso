...
namespace TicmansoWebApiV2.Context
{
    public partial class TicmansoDbContext : IdentityDbContext<ApplicationUser> 
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=88.12.111.123,1433;DataBase=TicmansoV2;Persist Security Info=True;User ID=BlazorAdmin;Password=m#Ilw8g35p>FJ&0;Trust Server Certificate=True;");
